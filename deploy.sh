fission spec init
fission env create --spec --name onb-br-enum-nationality-env --image nexus.sigame.com.br/fission-onboarding-br-enum-nationality:0.2.0-0 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
