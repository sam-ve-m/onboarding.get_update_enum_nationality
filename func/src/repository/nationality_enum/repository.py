...
from src.core.interfaces.repository.nationality_enum.interface import INationalityEnumRepository
from src.repository.enum_nationality_cache.repository import EnumNationalityCacheRepository
